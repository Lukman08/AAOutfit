...
<body class="hold-transition light-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                <div class="btn-group">
                    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                        ...
                        <i class="fas fa-user-alt"></i> Abi Malkhan
                    </button>
        ...
        <footer class="main-footer d-flex justify-content-between align-items-center">
            <div class="copyright">
                &copy; Copyright <strong><span>Aafashionstore</span></strong>. All Rights Reserved.
                Redesigned by <a class="text-dark font-weight-semi-bold" href="https://github.com/lukman08">Lukman Hakim</a>
            </div>
